...
Request.prototype.request = function () {  
  ...
  // For PUTs and POSTS without a body set content-length to zero
  if(~['PUT', 'POST'].indexOf(options.method) && typeof(options.headers['content-length']) === 'undefined' && !options.body) {
